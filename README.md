...
- **第二章：魔法命令行**
   ...
   * [# 2.17 快速找到指定文件的mime类型](https://github.com/ysl2/magic-python/blob/master/source/c02/c02_17.md)
...
- **第六章：良好编码习惯**
   ...
   * [# 6.4 别再使用 pprint 打印了](https://github.com/ysl2/magic-python/blob/master/source/c06/c06_04.md)
